...
def plot_trajectory_from_csv(trajectory_file, stretchtime=None):

    traj = uav_trajectory.Trajectory()
    traj.loadcsv(trajectory_file)
    if stretchtime:
    ...
    # print stats
    print("max height (m): ", np.max(evals[:, 2]))
    print("Duration (s): ", traj.duration)
